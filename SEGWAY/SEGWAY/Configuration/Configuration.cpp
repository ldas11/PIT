...
Configuration::s_ADCSensorConfig
	/*
	Diese Struktur beinhaltet die Konfiguration für den ADC und ist in configuration.h
	definiert. unsigned long ADCChannelID beinhaltet den Kanal des ADC der aktiviert
	werden soll, signed long zeroOffset übergibt den aktuellen Offset falls bereits vorhanden,
	bool useZeroOffset aktiviert oder deaktiviert die Verwendung des Offset.
	*/
